...
class __TwigTemplate_5ab22a51cb79b8c613bdea41b6ffe3bfd7d513ca5aa177f8223d6033892f241b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/content-edit/filter-tips.html.twig", "/app/themes/contrib/bootstrap_barrio/templates/content-edit/filter-tips.html.twig");
    }
